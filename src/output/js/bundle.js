...
/***/ function(module, exports, __webpack_require__) {
	...
	//引入组件
	var Nav = __webpack_require__(159); //顶部导航栏
	var Footer = __webpack_require__(160); //底部导航栏
	var Home = __webpack_require__(161); //首页页面
	var Login = __webpack_require__(163); //登陆页面
	var Message = __webpack_require__(166); //消息页面
	...
	var Main = React.createClass({
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(Child, { route: this.state.route, handleClick: this.handleClick, classOpacity: this.state.opacity }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Article = __webpack_require__(162);
	module.exports = React.createClass({
		displayName: 'exports',
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					null,
					'我是首页,url:',
					this.props.route /*this.state.message*/
				),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var Btn = __webpack_require__(164);
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(
					...
					null,
					'地址:',
					this.props.route /*this.state.msg*/
				),
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					null,
					'地址:',
					this.props.route /*this.props.location.pathname*/
				),
				React.createElement(
					'h2',
					null,
